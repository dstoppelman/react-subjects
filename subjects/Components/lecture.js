...
ReactDOM.render((
  <div>
    <ContentToggle title="Tacos">
      <p>A taco is a traditional Mexican dish composed of a corn or wheat tortilla folded or rolled around a
        filling.</p>
    </ContentToggle>
...
//  handleClick() {
//    this.setState({
//      state.isOpen: !this.state.state.isOpen
//    })
//
